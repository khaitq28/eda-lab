-- Initial schema for Enrichment Service
...
-- Placeholder for future enrichment result table
-- Enrichment records will be added when business logic is implemented
